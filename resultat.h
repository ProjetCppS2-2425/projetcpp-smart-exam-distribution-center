...
public:
    // Constructeurs
    resultat();
    resultat(int ID_ETUDIANT, const QString &NUMC_ETUDIANT, const QString &NOM, const QString &MATIERE, double NOTE, const QDate &DATE_RES, const QString &STATUT);
    resultat(const QString &NUMC_ETUDIANT, const QString &NOM, const QString &MATIERE, double NOTE, const QDate &DATE_RES, const QString &STATUT);
